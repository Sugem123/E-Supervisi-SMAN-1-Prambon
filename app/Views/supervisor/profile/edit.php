        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('supervisor/profile/update-photo') ?>" method="post" enctype="multipart/form-data" id="photoForm">
                        <?= csrf_field() ?>
                    ...
                    <form action="<?= base_url('supervisor/profile/update') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <a href="<?= base_url('/supervisor') ?>" class="btn btn-secondary">Batal</a>
                    </form>
                </div>
            </div>
        </div>
