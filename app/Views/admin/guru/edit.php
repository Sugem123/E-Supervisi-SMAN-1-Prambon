...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin/guru/' . $guru['id'] . '/update'); ?>" method="post">
                <?= csrf_field(); ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="mapel_id" name="mapel_id">
                            ...
                            <?php foreach (($mapels ?? []) as $mapel): ?>
                                <option value="<?= $mapel['id']; ?>" <?= (string) old('mapel_id', $guru['mapel_id'] ?? '') === (string) $mapel['id'] ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_supervisor" name="is_supervisor" value="1" <?= old('is_supervisor', $guru['is_supervisor']) ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="is_supervisor">
                            <?= $guru['is_supervisor'] ? 'Sudah menjadi Supervisor' : 'Jadikan sebagai Supervisor' ?>
                        </label>
                    </div>
                </div>
                <!-- Password Section -->
