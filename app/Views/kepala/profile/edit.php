        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('kepala/profile/update-photo') ?>" method="post" enctype="multipart/form-data" id="photoForm">
                        <?= csrf_field() ?>
                    ...
                    <form id="deletePhotoForm" action="<?= base_url('kepala/profile/delete-photo') ?>" method="post">
                        <?= csrf_field() ?>
                    </form>
                    
                    <hr>
                    
                    <form action="<?= base_url('kepala/profile/update') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <a href="<?= base_url('/kepala') ?>" class="btn btn-secondary">Batal</a>
                    </form>
                </div>
            </div>
        </div>
