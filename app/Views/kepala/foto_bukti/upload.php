...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('kepala/hasil') ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="col-lg-8">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><?= isset($schedule['guru_mata_pelajaran']) ? esc($schedule['guru_mata_pelajaran']) : '' ?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="uploadForm" action="<?= base_url('kepala/foto-bukti/upload/' . $schedule['id']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
        ...
        uploadForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.status === 'success') {
                    // Show success message (using SweetAlert if available, else alert)
    ...
    deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            const confirmDelete = () => {
                ...
                fetch(`<?= base_url('kepala/foto-bukti/delete') ?>/${photoId}`, {
                    method: 'POST',
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
