<?= $this->extend('layouts/kepala.php') ?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="<?= base_url('kepala/hasil/pdf/' . $schedule['id']) ?>" class="btn btn-danger btn-sm" target="_blank">
                <i class="fas fa-file-pdf"></i> PDF
            </a>
            <a href="<?= base_url('kepala/hasil/export/' . $schedule['id']) ?>" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            if (!empty($hasilList)) {
                foreach ($hasilList as $hasil) {
                    ...
                    // === PERBAIKAN: Hapus garis bawah dari nama komponen ===
