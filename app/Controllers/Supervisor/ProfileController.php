...
class ProfileController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->preferencesModel = new UserPreferencesModel();
    }
    ...
    public function edit()
    {
        ...
        $preferences = $this->preferencesModel->getPreferencesByUser($userId);
        ...
        return view('supervisor/profile/edit', $data);
    }
    ...
    public function update()
    {
        ...
        return redirect()->to('/supervisor')->with('success', 'Profil berhasil diperbarui');
    }
