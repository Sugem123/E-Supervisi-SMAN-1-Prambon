...
class PenilaianController extends BaseController
{
    ...
    public function form($jadwalId)
    {
        ...
        // Get schedule details - allow both 'Terjadwal' and 'Selesai' statuses for editing
        ...
        return view('supervisor/penilaian/form', $data);
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            // Validasi apakah jenis_penilaian_id ini diizinkan untuk kelompok jadwal ini
            $kelompokModel = new \App\Models\KelompokSupervisiModel();
            $kelompok = $kelompokModel->resolveKelompokForSchedule($schedule);
            $assignedIds = $kelompok ? $kelompokModel->getAssignedJenisIds((int)$kelompok['id']) : [];
            if (!empty($assignedIds) && !in_array((int)$jenisPenilaianId, $assignedIds, true)) {
                return $this->response->setJSON([
                    'status'  => 'error',
                    'message' => 'Komponen penilaian ini tidak ditugaskan untuk kelompok supervisi Anda.',
                    'token'   => csrf_hash()
                ]);
            }
    ...
    public function view($jadwalId)
    {
        ...
        return view('supervisor/penilaian/view', $data);
    }
    ...
    public function complete($jadwalId)
    {
        ...
        try {
            ...
            return $this->response->setJSON([
                ...
                'redirect' => base_url('supervisor/jadwal'),
                'token' => csrf_hash()
            ]);
